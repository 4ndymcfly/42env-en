...
require("lazy").setup({
  spec = {
    ...
    -- plugin 42 Formatter
    {
        ...
        -- Automatically load on C/C++ files
        ft = { "c", "cpp" },
        -- Optional: Additional configuration if necessary
        config = function()
...
local function set_spell_lang()
  ...
  elseif ft == 'python' or ft == 'html' then
    ...
    vim.opt.spelllang = 'en'  -- Default language
  end
end

-- Autocmd to apply spell checker configuration
